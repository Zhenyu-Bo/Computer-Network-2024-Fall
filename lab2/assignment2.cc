...
// Network topology:
//                20Mbps,1ms,errop=0      10Mbps,1ms,errop=0        10Mbps,1ms,errop=0
// n0(TcpNewReno) --------------------- n2 --------------------- n3 --------------------- n4
//                                    |                          |
//                                    |                          |
//               20Mbps,1ms,errop=0   |                          | 10Mbps,1ms,errop=0        
// n1(TcpVegas) ----------------------                            ----------------------- n5
//  
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue("transport_prot_0", "Transport protocol to use for node 0", transport_prot_0);
  cmd.AddValue("transport_prot_1", "Transport protocol to use for node 1", transport_prot_1);
  ...
  transport_prot_0 = std::string ("ns3::") + transport_prot_0;
  transport_prot_1 = std::string ("ns3::") + transport_prot_1;
